...
var carpColors = {
  ...
  "C33": {bg:"#CC99FF", fg:"#1a1a1a"},   // columna exterior izq
  "C34": {bg:"#994422", fg:"#ffffff"},   // columna exterior izq
  "C35": {bg:"#F2F2F2", fg:"#444444"},   // columna exterior izq
...
var H = 28;
var standsMap = [
  // Columna exterior izquierda (original)
  ["C40",28,278,58], ["C41",28,313,58], ["C42",28,348,58],
  ["C43",28,400,58], ["C44",28,438,58], ["C45",28,476,58],
  // Columna interior izquierda (original)
  ["C39",135,247,52], ["C38",135,282,52],
  ["C37",135,317,52], ["C36",135,350,52], ["C35",135,383,52],
  // C36 y C35 (original)
  ["C33",118,446,50], ["C34",118,478,50],
  // Columna central (C14-C25)
  ...
  ["C1",462,496,50],
  // Plaza Serafin (original)
  ["C32",199,410,42,24], ["C31",243,410,42,24],
  ["C30",199,440,42,24], ["C29",199,470,42,24],
  ["C28",197,498,30,22], ["C27",229,498,30,22], ["C26",261,498,28,22]
];
