...
var H = 28;
var standsMap = [
  // Columna exterior izquierda (x=28): C40→C45 arriba, C28→C26 abajo
  ["C40",28,200,58], ["C41",28,234,58], ["C42",28,268,58], ["C43",28,302,58],
  ["C44",28,366,58], ["C45",28,400,58],
  ["C28",28,448,58], ["C27",28,482,58], ["C26",28,516,58],
  // Columna interior izquierda (x=135): C39→C37
  ["C39",135,200,52], ["C38",135,234,52], ["C37",135,268,52],
  // C36 (naranja) y C35 debajo
  ["C36",118,320,50], ["C35",118,356,50],
