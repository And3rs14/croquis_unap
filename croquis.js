...
var H = 28;
var standsMap = [
  // Columna exterior izquierda: C40-C45 (top→bottom)
  ["C40",28,212,58], ["C41",28,247,58], ["C42",28,282,58],
  ["C43",28,317,58], ["C44",28,352,58], ["C45",28,387,58],
  // Columna interior izquierda: C35-C39 + C36 naranja
  ["C39",135,212,52], ["C38",135,247,52], ["C37",135,282,52],
  ["C36",118,317,50],
  ["C35",135,352,52],
  // C33 y C34 (abajo, área entre columna y plaza)
  ["C33",118,430,50], ["C34",118,462,50],
  ...
  ["C1",462,496,50],
  // Plaza Serafin (C26-C32)
  ["C32",148,410,44,28], ["C31",196,410,42,28],
  ["C30",148,441,44,28],
  ["C29",148,472,44,28],
  ["C28",148,503,44,28],
  ["C27",197,507,38,22], ["C26",238,507,35,22]
];
