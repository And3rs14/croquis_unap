...
var H = 28;
var standsMap = [
  // Columna exterior izquierda: mismas posiciones, labels corregidos
  ["C43",28,278,58], ["C44",28,313,58], ["C45",28,348,58],
  ["C33",28,400,58], ["C34",28,438,58], ["C35",28,476,58],
  // Columna interior izquierda: sin cambio de posición
  ["C42",135,212,52], ["C41",135,247,52], ["C40",135,282,52],
  ["C39",135,317,52], ["C38",135,350,52], ["C37",135,383,52],
  // C36 naranja (misma posición)
  ["C36",118,446,50],
  ...
  ["C1",462,496,50],
  // Plaza Serafin: mismas posiciones, labels C26-C32
  ["C26",199,410,42,24], ["C27",243,410,42,24],
  ["C28",199,440,42,24], ["C29",199,470,42,24],
  ["C30",197,498,30,22], ["C31",229,498,30,22], ["C32",261,498,28,22]
];
